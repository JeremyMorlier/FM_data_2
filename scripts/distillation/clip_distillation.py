...
# transforms ?
yfcc_dataloader = DataLoader(dataset, batch_size=batch_size_train, shuffle=False)
...
for student_name in student_names :
    for dataloader in dataloaders : 
        ...
        distillate(teacher.visual, student.visual, dataloader, batch_size_train, preprocess_train, student_preprocess_train, iterations, checkpoints, evaluate=None)
